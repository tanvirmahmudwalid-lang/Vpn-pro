...
export default function App() {
  ...
  const handleConnect = async () => {
    ...
    // Simulate Android System VPN Permission Dialog
    setShowSystemDialog(true);
  };

  const confirmSystemPermission = () => {
    ...
    if (targetServer.isPro && !user?.isPro && !user?.isPremium) {
    ...
    setTimeout(() => {
      setIsConnecting(false);
      setIsConnected(true);
      if (!user?.isPro && !user?.isPremium && remainingTime === 0) {
        setRemainingTime(360);
        if (user?.uid) {
          updateDoc(doc(db, 'users', user.uid), { sessionTimeRemaining: 360 });
        }
      }
    }, 2000);
  };
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: 'Btaf Meet',
          text: 'Experience high-speed and secure networking with Btaf Meet. Download now!',
  ...
  const handleContactAdmin = (platform: 'WhatsApp' | 'Telegram') => {
    const message = `Hello Admin, I want to upgrade to Btaf Meet Premium. My User ID is: ${user?.uid || 'Not Logged In'}`;
    ...
    return (
      <div className="fixed inset-0 bg-[#00A6EB] flex flex-col items-center justify-center z-[200]">
        ...
        >
          ...
          <h1 className="text-4xl font-black text-white tracking-tighter mb-2">Btaf Meet</h1>
          <p className="text-white/80 font-bold uppercase tracking-[0.2em] text-xs">Professional Networking</p>
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-white font-sans select-none">
      ...
      <header className="bg-[#FFD700] h-16 flex items-center px-4 shadow-md z-30 relative">
        ...
        <h1 className="flex-1 text-center text-xl font-black text-slate-800 tracking-tight">Btaf Meet</h1>
        <button 
            ...
            >
              <div className="p-6">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">Connection Request</h3>
                </div>
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button 
                    onClick={confirmSystemPermission}
                    className="rounded-lg bg-blue-600 px-6 py-2 text-sm font-bold text-white shadow-lg shadow-blue-200 hover:bg-blue-700"
                  >
                    OK
                  </button>
                </div>
          ...
          >
            <div className="bg-white h-full mt-20 rounded-t-[40px] flex flex-col overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                {[
                  { q: "What is Btaf Meet?", a: "Btaf Meet is a high-performance, secure networking service designed to connect professionals while protecting their privacy." },
      ...
      <AnimatePresence>
        {showAbout && (
          ...
          >
            <div className="bg-white h-full mt-20 rounded-t-[40px] flex flex-col overflow-hidden">
              <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                <h2 className="text-xl font-bold text-slate-800">About Btaf Meet</h2>
              ...
              <div className="flex-1 overflow-y-auto p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-slate-800 mb-1">Btaf Meet</h3>
                ...
                <div className="space-y-4 text-left">
                  ...
                  <div className="p-4 bg-slate-50 rounded-2xl">
                    ...
                    <p className="text-xs text-slate-500">By using Btaf Meet, you agree to our terms of service and acceptable use policy.</p>
                  </div>
                </div>
                
                <p className="mt-12 text-[10px] text-slate-300 uppercase tracking-widest font-bold">
                  © 2026 Btaf Meet Global. All Rights Reserved.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden flex flex-col">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-slate-500 text-sm mb-6">Upgrade to Btaf Meet Pro to remove all advertisements and unlock high-speed networking.</p>
                <button 
                  onClick={() => setShowInterstitial(false)}
            ...
            >
              ...
              <div className="p-8 overflow-y-auto text-sm text-slate-600 space-y-6">
                <section>
                  ...
                  <p>Btaf Meet collects minimal data to provide networking services, including your Google UID and email for account management. We do not log your browsing activity or IP addresses.</p>
                </section>
                <section>
